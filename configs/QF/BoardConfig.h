...
#define BUTTON_LAYOUT BUTTON_LAYOUT_STICK        // 左边摇杆
...
#define HOTKEY_00_BUTTONS_MASK (GAMEPAD_MASK_A1 | GAMEPAD_MASK_S2 | GAMEPAD_MASK_DU)   // A1 + S2 + UP
#define HOTKEY_00_DPAD_MASK 0
#define HOTKEY_00_ACTION 1  // DPAD DIGITAL

#define HOTKEY_01_AUX_MASK 0
#define HOTKEY_01_BUTTONS_MASK (GAMEPAD_MASK_A1 | GAMEPAD_MASK_S2 | GAMEPAD_MASK_DL)   // A1 + S2 + LEFT
#define HOTKEY_01_DPAD_MASK 0
#define HOTKEY_01_ACTION 2  // DPAD LEFT ANALOG

#define HOTKEY_02_AUX_MASK 0
#define HOTKEY_02_BUTTONS_MASK (GAMEPAD_MASK_A1 | GAMEPAD_MASK_S2 | GAMEPAD_MASK_DR)   // A1 + S2 + RIGHT
#define HOTKEY_02_DPAD_MASK 0
#define HOTKEY_02_ACTION 3  // DPAD RIGHT ANALOG
